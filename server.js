...
// Local logging fallback for generated projects
let projectLog = [];
...
async function projectAll(userId = 'default-system-user') {
  ...
  const requiredCoords = [
    key(0, 0, 0, 0.9, 1), // checkout playable
    key(1, 0, 0, 0.9, 1), // init playable
    key(2, 0, 0, 0.9, 1), // startGame playable
...
// ============================================================
// GITHUB HELPERS (For Codebase Generation ONLY)
// ============================================================
